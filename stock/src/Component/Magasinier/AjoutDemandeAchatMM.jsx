...
export default function AjoutDemandeAchatMM() {
  ...
  const [formData, setFormData] = useState({
    ...
    validation: "PAS ENCORE", // Nouveau champ: toujours "PAS ENCORE" et non modifiable
    commentaire: "",
    ...
    validePar: null, // Ne sera PAS automatiquement défini avec l'utilisateur connecté
    ...
    const getUserFromLocalStorage = () => {
      try {
        ...
        if (userData) {
          ...
          setCurrentUser(user)
          // Définir automatiquement l'utilisateur connecté comme créateur
          setFormData((prev) => ({
            ...prev,
            creePar: user,
            // validePar n'est plus automatiquement défini ici
          }))
        } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataToSend = {
        ...
        // S'assurer que l'utilisateur connecté est bien défini comme créateur
        creePar: formData.creePar ? { id: formData.creePar.id } : null,
        validePar: formData.validePar ? { id: formData.validePar.id } : null, // Utilise la valeur actuelle de formData.validePar
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4">
              <button
                onClick={() => navigate("/demandes-achatMM")}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-green-600">Ce champ est automatiquement défini sur "PAS ENCORE".</p>
                  </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  {/* Champ validée par - désactivé et non pré-rempli */}
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-4 py-2 pl-11 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 font-medium cursor-not-allowed appearance-none"
                      >
                    ...
                    <p className="text-xs text-gray-600">Ce champ n'est pas automatiquement défini.</p>
                  </div>
                </div>
